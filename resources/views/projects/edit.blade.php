    ...
    <div class="row">
        <div class="col-lg-12 margin-tb mt-5">
            ...
            <div class="pull-right">
                <a class="btn btn-primary" href="{{ route('projects.index') }}" title="Go back"> <i class="fas fa-arrow-left"></i> </a>
            </div>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="text" name="Accomplishment" class="form-control" placeholder="{{ $project->accomplishment }}"
            ...
            <div class="col-xs-12 col-sm-12 col-md-12">
                <div class="form-group">
                    ...
                    <input type="number" name="cost" class="form-control" placeholder="{{ $project->ranking}}"
